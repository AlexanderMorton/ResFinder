...
def plotInputs(inputsPath, outputPath, channels, backgrounds, signals, signalpt=Samp("",9,1)):
  ...
  for channel in channels:
    ...
    for background in backgrounds:
      ...
      hist.GetXaxis().SetTitle("m_{T}(vvJ) [GeV]")
...
#    masspt = masspt.split("p")[0]
    ...
    for event in mytree:
      ...
      if int(thismass) == masspt:
        ...
        scalefactor = 0.01
        signalsample = Samp(masspt,632,scalefactor) 
        break
      else: 
        print "setting sig SF to 1"
        signalsample = Samp(masspt,632,0.01) 
...
#  channels = ['ZHvvJ_1btag_1addbtag_mVH',
#              'ZHvvJ_1btaghmass_1addbtag_mVH',
#              'ZHvvJ_1btaghmass_mVH',
#              'ZHvvJ_1btag_mVH',
#              'ZHvvJ_2btaghmass_mVH',
#              'ZHvvJ_2btag_mVH']

  channels = ['ZHvvJ_0btag_1addbtag_mVH',
              'ZHvvJ_0btaghmasshigh_1addbtag_mVH',
              'ZHvvJ_0btaghmasshigh_mVH',
              'ZHvvJ_0btaghmasslow_1addbtag_mVH',
              'ZHvvJ_0btaghmasslow_mVH',
              'ZHvvJ_0btag_mVH',
              'ZHvvJ_1btag_1addbtag_mVH',
              'ZHvvJ_1btaghmasshigh_1addbtag_mVH',
              'ZHvvJ_1btaghmasshigh_mVH',
              'ZHvvJ_1btaghmasslow_1addbtag_mVH',
              'ZHvvJ_1btaghmasslow_mVH',
              'ZHvvJ_1btag_mVH',
              'ZHvvJ_2btaghmasshigh_mVH',
              'ZHvvJ_2btaghmasslow_mVH',
              'ZHvvJ_2btag_mVH']
