...
RF::Sample::Sample() : m_name(""), m_normByLumi(kFALSE), m_fitFunctionObs(""), m_fitFunctionFactoryCommand(""), m_fitFunctionPdf(0)
{
}

RF::Sample::Sample(TString name) : m_name(name), m_normByLumi(kFALSE), m_fitFunctionObs(""), m_fitFunctionFactoryCommand(""), m_fitFunctionPdf(0)
{
}
