...
void fileHolder::setUseStrings(bool flag) 
{
  useStrings=flag;
}

void fileHolder::setNrCols(int n) 
{
  nrCols = n;
}

bool fileHolder::readInFile(string name)
  {
...
void fileHolder::writeOutFile(string name)
  {
...
vector<double> fileHolder::getCol(int col)
  {
...
double fileHolder::getRate(int row, int col)
  {
...
void fileHolder::addMass(double mass, vector<double>& rate)
  {
  ...
  void fileHolder::addCol(vector<double>& addRates, int col)
  {
    int nrPoints = massPoints.size();
    for (int i=0;i<nrPoints;i++)
    {
