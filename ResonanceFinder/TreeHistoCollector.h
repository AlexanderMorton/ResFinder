...
namespace RF {
   ...
   public:
      ...
      void addChannel(TString channel, Int_t nbins, Double_t* bins, TString formula = "");
      void addChannel(TString channel, Int_t nbins, Double_t min, Double_t max, TString formula = "");
